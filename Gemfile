...
# --- Fase 1 (Rails Foundation) — Omni/Continuity ---
# Autenticação (ADR-003) — traz bcrypt como dependência
gem "devise"
# Autorização baseada em policies (ADR-004)
gem "pundit"
# Rate limiting / proteção de borda
gem "rack-attack"
